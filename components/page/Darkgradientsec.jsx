  ...
  const sectors = [
    {
      ...
      color: {
        ...
        cta: "text-emerald-500 hover:text-emerald-400",
      },
      icon: (
    ...
    },
    {
      ...
      color: {
        ...
        cta: "text-indigo-500 hover:text-indigo-400",
      },
      icon: (
        <svg className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
          <path d="M7 7a5 5 0 119.584 1.688A4 4 0 1116 19H7a4 4 0 01-1-7.874A5 5 0 017 7z" />
        </svg>
      ),
      options: [
    ...
    },
    {
      ...
      color: {
        ...
        text: "text-sky-600",
        ring: "ring-sky-100",
        cta: "text-sky-500 hover:text-sky-400",
      },
      icon: (
        <svg className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
          <path d="M7 2h10a2 2 0 012 2v16a2 2 0 01-2 2H7a2 2 0 01-2-2V4a2 2 0 012-2zm0 4h10v12H7V6z" />
        </svg>
      ),
      options: [
    ...
    },
    {
      ...
      color: {
        ...
        text: "text-rose-600",
        ring: "ring-rose-100",
        cta: "text-rose-500 hover:text-rose-400",
      },
      icon: (
        <svg className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
          <path d="M3 4h18v4H3V4zm0 6h11v10H3V10zm13 0h5v6h-5v-6z" />
        </svg>
      ),
      options: [
    ...
    },
    {
      ...
      color: {
        ...
        text: "text-amber-600",
        ring: "ring-amber-100",
        cta: "text-amber-500 hover:text-amber-400",
      },
      icon: (
        <svg className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
          <path d="M12 3l7 4-7 4-7-4 7-4zm0 9l7 4-7 4-7-4 7-4z" />
        </svg>
      ),
      options: [
    ...
    },
    {
      ...
      color: {
        ...
        cta: "text-fuchsia-500 hover:text-fuchsia-400",
      },
      icon: (
        <svg
          className="h-5 w-5"
    ...
    },
    {
      ...
      color: {
        ...
        text: "text-cyan-600",
        ring: "ring-cyan-100",
        cta: "text-cyan-500 hover:text-cyan-400",
      },
      icon: (
        <svg className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
    ...
    },
    {
      ...
      color: {
        ...
        text: "text-teal-600",
        ring: "ring-teal-100",
        cta: "text-teal-500 hover:text-teal-400",
      },
      icon: (
        <svg className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
          <path d="M3 12l9-7 9 7v9a1 1 0 01-1 1h-5v-6H9v6H4a1 1 0 01-1-1v-9z" />
        </svg>
      ),
      options: [
    ...
    },
    {
      ...
      color: {
        ...
        text: "text-slate-700",
        ring: "ring-slate-200",
        cta: "text-slate-400 hover:text-slate-300",
      },
      icon: (
        <svg className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
          <path d="M12 3l6 3v3a6 6 0 11-12 0V6l6-3zm-7 14h14v2H5v-2z" />
        </svg>
      ),
      options: [
    ...
    },
    {
      ...
      icon: (
        <svg className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
          <path d="M7 3c2 0 3 1 5 1s3-1 5-1c2 0 4 2 4 4 0 6-3 9-4 9-2 0-2-3-5-3s-3 3-5 3c-1 0-4-3-4-9 0-2 2-4 4-4z" />
        </svg>
      ),
      options: [
    ...
    },
    {
      ...
      color: {
        ...
        cta: "text-violet-500 hover:text-violet-400",
      },
      icon: (
        <svg className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
          <path d="M3 10l9-7 9 7v9H3v-9zm4 2h2v5H7v-5zm4 0h2v5h-2v-5zm4 0h2v5h-2v-5z" />
        </svg>
      ),
      options: [
    ...
    },
    {
      ...
      icon: (
        // mortarboard
        <svg className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
          <path d="M12 3l10 5-10 5L2 8l10-5zm8 8v5a1 1 0 01-.553.894L12 20l-7.447-3.106A1 1 0 014 16v-5l8 4 8-4z" />
        </svg>
      ),
      options: [
    ...
    },
    {
      ...
      color: {
        ...
        text: "text-pink-600",
        ring: "ring-pink-100",
        cta: "text-pink-500 hover:text-pink-400",
      },
      icon: (
        // sparkles
        <svg className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
          <path d="M5 3l2 4 4 2-4 2-2 4-2-4-4-2 4-2 2-4zm12 3l1 3 3 1-3 1-1 3-1-3-3-1 3-1 1-3zm-2 9l1 2 2 1-2 1-1 2-1-2-2-1 2-1 1-2z" />
        </svg>
      ),
      options: [
    ...
    },
    {
      ...
      icon: (
        // truck
        <svg className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
          <path d="M3 6h10v7h6l2 3v2h-2a2 2 0 11-4 0H9a2 2 0 11-4 0H3V6zm13 1h2l3 4h-5V7z" />
        </svg>
      ),
      options: [
    ...
    },
    {
      ...
      color: {
        ...
        cta: "text-purple-500 hover:text-purple-400",
      },
      icon: (
        // play
        <svg className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
  ...
  const renderCard = (s) => (
    <div className="h-full rounded-2xl bg-[#201E1C] p-6">
      <div className="flex items-center gap-3">
        <span
          className={`inline-flex h-10 w-10 items-center justify-center rounded-xl ${s.color.bg} ${s.color.text} ring-1 ${s.color.ring}`}
        >
          {s.icon}
        </span>
          ...
          <h2 className="text-center text-3xl md:text-5xl font-bold leading-tight text-white">
            <div className="mb-4 flex items-center justify-center">
              <div className="inline-flex items-center gap-2 pl-1 pr-2 py-1 rounded-full border border-[#53C1BC]/30 text-white">
                <span className="px-3 py-1 text-[11px] tracking-wide font-semibold rounded-full bg-linear-to-r from-[#53C1BC] via-[#3FA29E] to-[#2B7470]">
                  Steps
                </span>
                <span className="text-xs md:text-sm font-medium pr-1">
                  Discover how VoiceFlow works
                </span>
              </div>
            </div>
            {before}
        ...
        {[
          {
            ...
            desc: "You can create and edit projects to organize different powerpoints with different scripts.",
          },
          {
            src: "step2.webm",
            type: "video",
            title: "Choose your own settings",
            desc: "Choose your own trigger words to navigate your slides, and control commands.",
          },
          {
            src: "step3.webm",
            type: "video",
            title: "Start presentation",
            desc: "Upload your powerpoint.pptx file, click start presentation and begin your talk.",
          },
              ...
              <div className="space-y-6">
                ...
                >
                  ...
                  >
                    <ul className="flex min-w-max gap-6">
                      {sectors
                        .slice(0, Math.ceil(sectors.length / 2))
                        .map((s) => (
                          <li
                            key={s.name}
                ...
                >
                  ...
                  >
                    <ul className="flex min-w-max gap-6">
                      {sectors
                        .slice(Math.ceil(sectors.length / 2))
                        .map((s) => (
                          <li
                            key={s.name}
                            className="w-[380px] md:w-[420px]"
