      ...
      <div className="relative z-10 py-12 md:py-20 text-center">
        ...
        <div className="mb-4 flex items-center justify-center">
          <div className="inline-flex items-center gap-2 pl-1 pr-2 py-1 rounded-full border border-[#53C1BC]/90 text-black">
            <span className="px-3 py-1 text-[11px] tracking-wide font-semibold rounded-full bg-linear-to-r from-[#53C1BC] via-[#3FA29E] to-[#2B7470] text-white">Features</span>
            <span className="text-xs md:text-sm font-medium pr-1">What we do</span>
          </div>
        </div>
        ...
        <p className="mt-4 max-w-lg mx-auto text-gray-700 text-sm md:text-base">
          Navigating your powerpoint should be as easy as talking. VoiceFlow keeps
          everything streamlined and easy to manage from its simple-to-use interface.
          It’s designed for a human-first storytelling experience.
          No more needing to search for buttons.
        </p>
      </div>
              ...
              <div className="rounded-[26px] bg-white overflow-hidden">
                <div className="p-6 md:p-8 pb-0 md:-mb-4 mb-4">
                  ...
                  <p className="mt-5 text-sm md:text-base text-gray-600">
                    Use basic trigger words like "Next" and "Back" to navigate through your PowerPoint flawlessly.
                    Change these trigger words to anything you want to suit your style. 
                  </p>
                </div>
            ...
            <div className="relative rounded-[28px] border border-gray-200 bg-white shadow-[0_8px_30px_rgba(0,0,0,0.06)]">
              <div className="rounded-[26px] bg-white overflow-hidden">
                <div className="p-6 md:p-8 pb-0 md:-mb-4 mb-4">
                  ...
                  <p className="mt-5 text-sm md:text-base text-gray-600">
                    Choose words from your script and use them to navigate your slides.
                    This allows you to hide trigger words. A simple queue of words will navigate your PowerPoint from the first to the last slide.
                  </p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2">
                  ...
                  <span className="text-sm md:text-base font-semibold bg-clip-text text-transparent bg-linear-to-r from-[#53C1BC] via-[#3FA29E] to-[#2B7470]">
                    ...
                    <p className="mt-5 -mb-2 md:mb-4 text-sm md:text-base text-gray-600 max-w-xl">
                      By saying "Hey PowerPoint" you can now ask your powerpoint for specific actions like
                      "give me a blackscreen", or "turn on a timer of 5 minutes" and more.
                      Edit your command prefix from "Hey PowerPoint" to anything you want in the settings.
                      We are determined to add extra commands every week based on user feedback.
                    </p>
                  </div>
          ...
          <div className="relative grid gap-8 md:grid-cols-2 md:gap-16 items-start">
            ...
            <div className="md:pl-12">
              ...
              <blockquote className="mt-6 text-left leading-relaxed text-gray-700 text-sm md:text-base">
                We did tests with other companies, and VoiceFlow's voice recognition
                seems to be on top of its competition. It is crazy
                to think about how the future of storytelling will change.
                Remote controllers have their advantages but VoiceFlow has been much more sustainable and
                affordable.
              </blockquote>
